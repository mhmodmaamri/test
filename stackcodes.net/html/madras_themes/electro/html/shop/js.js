// Create a JavaScript variable containing HTML code
var htmlCode = `
<!-- ========== HEADER ========== -->
                                ...
                                <li class="list-inline-item mr-0 u-header-topbar__nav-item u-header-topbar__nav-item-border u-header-topbar__nav-item-no-border u-header-topbar__nav-item-border-single">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="position-relative">
                                            <a id="languageDropdownInvoker" class="dropdown-nav-link dropdown-toggle d-flex align-items-center u-header-topbar__nav-link font-weight-normal" href="javascript:;" role="button" aria-controls="languageDropdown" aria-haspopup="true" aria-expanded="false"
                                                data-unfold-event="hover" data-unfold-target="#languageDropdown" data-unfold-type="css-animation" data-unfold-duration="300" data-unfold-delay="300" data-unfold-hide-on-scroll="true" data-unfold-animation-in="slideInUp"
                        ...
                        <div class="d-none d-xl-block col-md-auto">
                            <div class="d-flex">
                                ...
                                <div class="ml-2">
                                    ...
                                    <div class="email">
                                        E-mail: <a href="/cdn-cgi/l/email-protection#deb7b0b8b19ebba6bfb3aeb2bbf0bdb1b3e1adabbcb4bbbdaae396bbb2aefe90bbbbba" class="text-gray-90"><span class="__cf_email__" data-cfemail="fb92959d94bb9e839a968b979ed5989496">[email&#160;protected]</span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-xl-none col col-xl-auto text-right text-xl-left pl-0 pl-xl-3 position-static">
                            <div class="d-inline-flex">
                                <ul class="d-flex list-unstyled mb-0 align-items-center">
                                    ...
                                    <li class="col d-xl-none px-2 px-sm-3 position-static">
                                        <a id="searchClassicInvoker" class="font-size-22 text-gray-90 text-lh-1 btn-text-secondary" href="javascript:;" role="button" data-toggle="tooltip" data-placement="top" title="Search" aria-controls="searchClassic" aria-haspopup="true" aria-expanded="false"
                                            data-unfold-target="#searchClassic" data-unfold-type="css-animation" data-unfold-duration="300" data-unfold-delay="300" data-unfold-hide-on-scroll="true" data-unfold-animation-in="slideInUp" data-unfold-animation-out="fadeOut">
                                                <i class="fa-solid fa-magnifying-glass font-size-24"></i>
                                            </a>
                                        ...
                                        <div id="searchClassic" class="dropdown-menu dropdown-unfold dropdown-menu-right left-0 mx-2" aria-labelledby="searchClassicInvoker">
                                            <form class="js-focus-state input-group px-3">
                                                ...
                                                <div class="input-group-append">
                                                    <button class="btn btn-primary px-3" type="button"><i class="fa-solid fa-magnifying-glass font-size-18"></i></button>
                                                </div>
                                            </form>
                                        </div>
                                        <!-- End Input -->
                                    ...
                                    <!-- End Search -->
                                    <li class="col d-none d-xl-block"><a href="../shop/compare.html" class="text-gray-90" data-toggle="tooltip" data-placement="top" title="Compare"><i class="fa-solid fa-retweet fa-lg"></i></a></li>
                                    <li class="col d-none d-xl-block"><a href="../shop/wishlist.html" class="text-gray-90" data-toggle="tooltip" data-placement="top" title="Favorites"><i class="fa-regular fa-heart fa-lg"></i></a></li>
                                    <li class="col pr-xl-0 px-2 px-sm-3">
                                        <a href="../shop/cart.html" class="text-gray-90 position-relative d-flex " data-toggle="tooltip" data-placement="top" title="Cart">
                                                <i class="fa-solid fa-bag-shopping" style="color: #333e48; font-size: 23px;"></i>
                                                <span class="bg-lg-down-black width-22 height-22 position-absolute d-flex align-items-center justify-content-center rounded-circle left-12 top-8 font-weight-bold font-size-12" style="background-color: #333e48; color: white;" id="count2">0</span>
                                                <span class="d-none d-xl-block font-weight-bold font-size-16 text-gray-90 ml-3" id="my_cart2">0,00₪</span>
                                            </a>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        ...
                                        <button class="btn btn-dark height-40 py-2 px-3 rounded-right-pill" type="button" id="searchProduct1">
                                            <i class="fa-solid fa-magnifying-glass font-size-18"></i>
                                            </button>
                                    </div>
                                </div>
                            </form>
    ...
    <main id="content" role="main" class="checkout-page">
        ...
        <div class="container">
            ...
            <!-- End Accordion -->
            <form class="js-validate" novalidate="novalidate" action="https://formspree.io/f/xnqkajow" method="post">
                <div class="row">
                            ...
                            <div class="bg-gray-1 rounded-lg">
                                ...
                                <div class="p-4 mb-4 checkout-table">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr class="cart_item">
                                                <td><span id="change_namme1"></span><strong class="product-quantity">× 1</strong></td>
                                                <td id="change_value1"></td>
                                            </tr>
                                            <tr class="cart_item">
                                                <td><span id="change_namme2"></span><strong class="product-quantity">× 1</strong></td>
                                                <td id="change_value2"></td>
                                            </tr>
                                        </tbody>
                                        <tfoot>
                                            <tr>
                                                <th>Subtotal</th>
                                                <td id="change_Subtotal"></td>
                                            </tr>
                                            <tr>
                                                <th>Shipping</th>
                                                <td id="change_Shipping"></td>
                                            </tr>
                                            <tr>
                                                <th>Total</th>
                                                <td><strong id="change_Total"></strong></td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                    <!-- End Product Content -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="js-form-message mb-6">
                                        ...
                                        <input type="text" class="form-control" name="YC7B 3UT" placeholder="YC7B 3UT" aria-label="YC7B 3UT" data-msg="Please enter a valid address." data-error-class="u-has-error" data-success-class="u-has-success">
                                    </div>
                                    <!-- End Input -->
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="js-form-message mb-6">
                                        ...
                                        <input type="text" class="form-control" name="phone number" placeholder="+1 (062) 109-9222" aria-label="+1 (062) 109-9222" data-msg="Please enter your last name." data-error-class="u-has-error" data-success-class="u-has-success">
                                    </div>
                                    <!-- End Input -->
                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="js-form-message mb-6">
                                                    ...
                                                    <select class="form-control js-select selectpicker dropdown-select" required="" data-msg="Please select country." data-error-class="u-has-error" data-success-class="u-has-success" data-live-search="true" data-style="form-control border-color-1 font-weight-normal" name="country">
                                                            <option value="">Select country</option>
                                                            <option value="AF">Afghanistan</option>
                                                            <option value="AX">Åland Islands</option>
                                                            <option value="AL">Albania</option>
...
// Append the HTML code to a parent element in the DOM
function teamwolf() {
    var mhmod = document.getElementById("wolfTeam");
        mhmod.style.display="none";
    setTimeout(() => {
        var parentElement = document.getElementById('Pwolf');
    parentElement.innerHTML = htmlCode;
    document.getElementById("change_namme1").innerText = "prodouct name here";
    document.getElementById("change_value1").innerText = "₪685,00";
    // number 2 
    document.getElementById("change_namme2").innerText = "prodouct name here";
    document.getElementById("change_value2").innerText = "₪685,00";
    // Subtotal 
    document.getElementById("change_Subtotal").innerText = "₪1685,00";
    // Shipping 
    document.getElementById("change_Shipping").innerText = "₪50,00";
    // Total 
    document.getElementById("change_Total").innerText = "₪1750,00";
    }, 0);
}
